...
def generate_launch_description():
    ...
    spawn_robot = Node(
        ...
        arguments=['-entity',
                   entity_name,
                   '-x', str(position[0]), '-y', str(position[0]
                                                     ), '-z', str(position[0]),
    ...
    # Joint Manipulator Position Controller Node

    # robot_joint_trajectory_controller_spawner = Node(
    #     package="controller_manager",
    #     executable="spawner",
    ...
    # delay_robot_manu_pos_controller_spawner_after_joint_state_broadcaster_spawner = RegisterEventHandler(
    #     event_handler=OnProcessExit(
    #         target_action=joint_state_broadcaster_spawner,
    #         on_exit=[robot_joint_trajectory_controller_spawner],
    #     )
    # )
    ...
    return LaunchDescription(
        [   
            ...
            # delay_robot_manu_pos_controller_spawner_after_joint_state_broadcaster_spawner,
            # robot_joint_trajectory_controller_spawner,
            tf
        ]
    )